...
export interface IBeaconChain {
  ...
  processBlock(signedBlock: allForks.SignedBeaconBlock, opts?: ImportBlockOpts): Promise<void>;
  /** Process a chain of blocks until complete */
  processChainSegment(signedBlocks: allForks.SignedBeaconBlock[], opts?: ImportBlockOpts): Promise<void>;
